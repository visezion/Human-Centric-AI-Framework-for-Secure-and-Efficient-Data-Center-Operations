...
A PhD-ready yet lightweight reference stack that demonstrates end-to-end telemetry ingestion, explainable AI analytics, and a human-centric dashboard for secure and efficient data center operations.
